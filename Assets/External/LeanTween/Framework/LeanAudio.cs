     ...
     */
		...
		AudioClip audioClip = AudioClip.Create("Generated Audio", lengthSamples, 1, options.frequencyRate, is3dSound, false);
            ...
            if (options.useSetData) {
                ...
                audioClip = AudioClip.Create("Generated Audio", lengthSamples, 1, options.frequencyRate, false, options.stream.OnAudioRead,
        ...
        public static AudioSource play(AudioClip audio) => playClipAt(audio, Vector3.zero);

        public static AudioSource play(AudioClip audio, Vector3 pos) => playClipAt(audio, pos);
