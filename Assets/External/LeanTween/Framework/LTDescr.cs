    ...
    public class LTDescr {
        ...
        public LTDescr setRotateAroundLocal() {
            ...
            this.easeInternal = () => {
                ...
                val = newVect.x;
                Vector3 origPos = this.trans.localPosition;
                this.trans.RotateAround(this.trans.TransformPoint(this._optional.point), this.trans.TransformDirection(this._optional.axis),
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
     ...
     */
        ...
        private Vector3 tweenOnCurve() =>
            new Vector3(this.from.x + this.diff.x * this._optional.animationCurve.Evaluate(this.ratioPassed),
...
//		val = (val * val * val * val - 2f);
        ...
        private Vector3 easeInElastic() =>
            new Vector3(LeanTween.easeInElastic(this.from.x, this.to.x, this.ratioPassed, this.overshoot, this.period),
        ...
        private Vector3 easeOutElastic() =>
            new Vector3(LeanTween.easeOutElastic(this.from.x, this.to.x, this.ratioPassed, this.overshoot, this.period),
        ...
        private Vector3 easeInOutElastic() =>
            new Vector3(LeanTween.easeInOutElastic(this.from.x, this.to.x, this.ratioPassed, this.overshoot, this.period),
     ...
     */
        ...
        public LTDescr setFrom(float from) => this.setFrom(new Vector3(from, 0f, 0f));
