...
namespace External.LeanTween.Framework {
    ...
    public class LeanTest : object {
        ...
        public static void debug(string name, bool didPass, string failExplaination = null) => expect(didPass, name, failExplaination);
        ...
        public static string formatBC(string str, string color) => formatC(formatB(str), color);
        ...
        public static void overview() {
            ...
            Debug.Log(formatB("Final Report:")
